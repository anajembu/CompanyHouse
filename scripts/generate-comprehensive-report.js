...
function main() {
  ...
  // Sample data - in real implementation, this would come from test execution
    ...
    violations: [
      {
        ...
        nodes: [{ any: [{ message: 'Add alt attribute to img elements' }] }]
      },
      {
        impact: 'serious',
        help: 'Form controls must have labels',
        description: 'Form inputs without labels are not accessible',
        nodes: [{ any: [{ message: 'Add label elements or aria-label attributes' }] }]
      }
    ]
  };
